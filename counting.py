    ...
    while cap.isOpened():
        ...
        if frame_count % 2 == 0:
            ...
            for det in detections:
                ...
                # if obj_id is None or min_distance > max((x2 - x1) // 2, offset * 2):
                if obj_id is None or min_distance > 100:
                ...
                if obj_id in tracked_objects:
                    ...
                    if not counted and prev_x < line_x and center_x >= line_x and obj_id not in crossed_objects:
                        ...
                        print(f"Class '{prev_class}' (ID {obj_id}) count: {class_counters[prev_class]}")
